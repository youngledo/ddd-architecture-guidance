...
| Spring Boot AOT + GraalVM Native Image optional capability | Matching Spring implementation guide, compatibility evidence, and the selected profile's consumer test for the persistence, lock, or scheduler combination |
